...
This module implements comprehensive visualization capabilities for global
point cloud maps created through collaborative perception of multiple robots
in warehouse environments. It provides interactive 3D visualizations, temporal
animations, and detailed analysis tools for collaborative sensor fusion results.

Key Features:
- Interactive 3D global map visualization
- Multi-robot point cloud overlay and comparison
- Temporal animation of collaborative perception evolution
- Workstation and warehouse infrastructure visualization
- Statistical analysis and quality assessment plots
- Export capabilities for presentations and analysis

The visualizer is essential for validating collaborative perception results
and understanding the spatial relationships in multi-robot sensor fusion.
...
class CollaborativePerceptionGlobalMapVisualizer:
    """
    Advanced Global Map Visualizer for Collaborative Perception Systems.

    This class provides comprehensive visualization capabilities for global
    point cloud maps generated through collaborative perception of multiple
    autonomous robots. It supports interactive 3D visualization, temporal
    analysis, and detailed quality assessment of collaborative sensor fusion.

    Key Visualization Features:
    - 3D global point cloud maps with multi-robot data overlay
    - Interactive exploration with zoom, pan, and rotation
    - Temporal animation showing collaborative perception evolution
    - Warehouse infrastructure and workstation visualization
    - Statistical analysis plots and quality metrics
    - Export capabilities for documentation and presentations
    """

    def __init__(self, transformed_data_path: Optional[str] = None):
        """
        Initialize the collaborative perception global map visualizer.

        Args:
            transformed_data_path (str, optional): Path to coordinate-transformed data CSV file
                                                  containing global point cloud data
        """
        self.transformed_data_path = transformed_data_path
        self.loaded_global_map_data = None
        ...
        # Define workstation physical dimensions for visualization
        self.workstation_physical_dimensions = {
            'width_meters': 1.0,
            'height_meters': 0.6,
            'depth_meters': 0.8
        }
        ...
        self.collaborative_visualization_colors = {
            'robot_1_data': 'blue',
            'robot_2': 'red',
            'workstation': 'gray',
            'boundary': 'black'
...
def main():
    ...
    # Create collaborative perception global map visualizer
    visualizer = CollaborativePerceptionGlobalMapVisualizer()
